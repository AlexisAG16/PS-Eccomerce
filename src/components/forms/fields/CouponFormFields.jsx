  ...
  return (
    <div className="space-y-8 max-h-[70vh] overflow-y-auto pr-2 custom-scrollbar pb-4">
      ...
      <fieldset className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex flex-col gap-1">
            <label className="text-[9px] font-black text-gray-400 uppercase ml-1">Código (Ej: VERANO20)</label>
            <input {...register("code", { required: true })} className="border-2 border-gray-100 rounded-xl p-3 uppercase font-black" placeholder="CÓDIGO" />
          </div>
          <div className="flex flex-col gap-1">
            <label className="text-[9px] font-black text-gray-400 uppercase ml-1">Límite de usos (total)</label>
            <input type="number" {...register("usageLimit")} className="border-2 border-gray-100 rounded-xl p-3" placeholder="Sin límite" />
          </div>
        </div>
      </fieldset>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className="border-2 border-gray-100 rounded-xl p-3 outline-none focus:border-brand-primary"
            />
          </div>
          <div className="flex flex-col gap-1">
      ...
      <fieldset className="bg-gray-50 p-6 rounded-4xl border border-gray-100 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="flex flex-col gap-1">
            ...
            <select {...register("discountType")} className="border-2 border-white rounded-xl p-3 bg-white font-bold text-gray-700 outline-none">
              <option value="percentage">Porcentual (%)</option>
              <option value="fixed">Monto Fijo ($)</option>
            </select>
          </div>
          <div className="flex flex-col gap-1">
            <label className="text-[9px] font-black text-gray-400 uppercase ml-1">Valor</label>
            <input type="number" {...register("value", { required: true })} className="border-2 border-white rounded-xl p-3 bg-white font-black text-brand-primary outline-none" />
          </div>
        </div>
      </fieldset>
      ...
      <fieldset className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex flex-col gap-1">
            <label className="text-[9px] font-black text-gray-400 uppercase ml-1">Usos permitidos por cliente</label>
            <input type="number" defaultValue={1} {...register("usagePerUser")} className="border-2 border-gray-100 rounded-xl p-3" placeholder="Ej: 1" />
          </div>
          <div className="flex flex-col gap-1">
            <label className="text-[9px] font-black text-gray-400 uppercase ml-1">Monto de compra mínima ($)</label>
            <input type="number" {...register("minOrderAmount")} className="border-2 border-gray-100 rounded-xl p-3" placeholder="Ej: 5000" />
          </div>
          <div className="flex flex-col gap-1">
            <label className="text-[9px] font-black text-gray-400 uppercase ml-1">Mínimo de ítems en carrito</label>
            <input type="number" {...register("minItems")} className="border-2 border-gray-100 rounded-xl p-3" placeholder="Ej: 2" />
          </div>
      ...
      <fieldset className="grid grid-cols-2 gap-4">
        <div className="space-y-4">
          ...
          <div className="h-32 overflow-y-auto bg-gray-50 p-2 rounded-xl text-[10px]">
