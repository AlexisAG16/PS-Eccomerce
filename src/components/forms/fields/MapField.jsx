...
const MapField = ({ control, name, center = [-28.4696, -65.7852] }) => {
  ...
  return (
    /* 🎯 Agregamos 'relative z-0' al contenedor padre para domar a Leaflet por completo */
    <div className="h-64 rounded-3xl overflow-hidden border-2 border-white shadow-inner relative z-0">
