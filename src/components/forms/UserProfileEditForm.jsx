    ...
    <div className="space-y-10 max-h-[70vh] overflow-y-auto pr-4 custom-scrollbar pb-6">
      ...
      <fieldset className="space-y-6">
        <div className="flex items-center gap-2 border-b border-brand-border pb-2">
          ...
          <legend className="text-[11px] font-black text-brand-text uppercase tracking-[0.2em]">Identidad</legend>
        </div>
      ...
      {/* SECCIÓN DIRECCIÓN */}
      <fieldset className="space-y-6 bg-brand-bg/70 p-6 rounded-[2.5rem] border border-brand-border">
        <div className="flex items-center gap-2 border-b border-brand-border pb-2">
          <FiMapPin className="text-brand-secondary" />
          <legend className="text-[11px] font-black text-brand-text uppercase tracking-[0.2em]">Dirección</legend>
        </div>
      ...
      <fieldset className="space-y-6">
        <div className="flex items-center gap-2 border-b border-brand-border pb-2">
          ...
          <legend className="text-[11px] font-black text-brand-text uppercase tracking-[0.2em]">Ubicación</legend>
        </div>
        <MapField
          control={control}
