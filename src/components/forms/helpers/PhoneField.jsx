    ...
    <Controller
      ...
      render={({ field: { onChange, value } }) => (
        <PhoneInput
          ...
          value={value}
          onChange={onChange}
          className="border-2 border-brand-border bg-brand-bg rounded-2xl p-4 focus-within:border-brand-highlight outline-none font-bold text-brand-text shadow-sm transition-all"
        />
      )}
    />
  </div>
